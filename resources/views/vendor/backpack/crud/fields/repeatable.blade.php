...
<div class="container-repeatable-elements">
    ...
    <div class="col-md-12 well repeatable-element row m-1 p-2" data-repeatable-identifier="{{ $field['name'] }}">
      @if (isset($field['fields']) && is_array($field['fields']) && count($field['fields']))
        ...
        @endforeach
        <div class="btn-group">
            <button type="button" class="btn btn-outline-info btn-sm movefirst-element"><i class="la la-angle-double-up"></i></button>
            <button type="button" class="btn btn-outline-info btn-sm moveup-element"><i class="la la-angle-up"></i></button>
            <button type="button" class="btn btn-outline-info btn-sm movedown-element"><i class="la la-angle-down"></i></button>
            <button type="button" class="btn btn-outline-info btn-sm movelast-element"><i class="la la-angle-double-down"></i></button>
        </div>
      @endif
    </div>
    @endpush
  ...
  @push('crud_fields_scripts')
      <script>
        ...
        function newRepeatableElement(container, field_group, values) {
            ...
            new_field_group.find('.moveup-element').click(function() {
                new_field_group.insertBefore(new_field_group.prev());
            });
            new_field_group.find('.movedown-element').click(function() {
                new_field_group.insertAfter(new_field_group.next());
            });
            new_field_group.find('.movefirst-element').click(function() {
                new_field_group.prependTo(new_field_group.parent());
            });
            new_field_group.find('.movelast-element').click(function() {
                new_field_group.appendTo(new_field_group.parent());
            });
